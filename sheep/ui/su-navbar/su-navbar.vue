      ...
      >
        ...
        >
          <slot name="left">
            <view class="uni-navbar__content_view" v-if="leftIcon.length > 0">
              <view class="icon-box ss-flex" v-if="isMore">
                <view class="icon-button icon-button-left ss-flex ss-row-center" @tap="onClickLeft">
                  <text class="sicon-back" v-if="hasHistory || isClickLeft" />
              ...
              <view
                class="icon-button icon-button-left ss-flex ss-row-center f-s-24"
                @tap="onClickLeft"
                v-else
              >
                <text class="sicon-back" v-if="hasHistory || isClickLeft" />
        ...
        <view v-else class="uni-navbar__header-container" @tap="onClickTitle">
          <slot name="center">
            ...
            >
              <text :style="{ color: themeColor }" class="ss-line-1 default-title f-w-600">{{
                title
              }}</text>
            </view>
          </slot>
...
<script setup>
  ...
  function onClickLeft() {
    if (props.isClickLeft) return emits('clickLeft');
    if (hasHistory) {
      sheep.$router.back();
    } else {
